...
public class Almoxarife extends Funcionario {
    ...
    public Almoxarife(int idFuncionario, String nome, LocalDate dataDeNascimento, int cpf, float salario, LocalDate dataDeInicio, String turno, String funcao, int qtdOperacoesDia, LocalDate dataUltimoReabastecimento, int qtdInsumosReabastecidos) {
